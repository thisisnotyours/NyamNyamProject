...
public class FoodCategoryPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new CategoryPageItems("https://www.feastingathome.com/wp-content/uploads/2018/01/Korean-Seoul-Bowl-vegan-bibimbap-100-4.jpg",R.drawable.bibimbap, "VEGAN", "Chaesik", "It's not a secret that Korea is well known as meat paradise for those meat lovers. But that doesn't mean that vegetarians can't have Korean food! We'll share general dishes how to enjoy Korean food like a pure vegetarian and you will soon fall in love."));
        items.add(new CategoryPageItems("https://i.pinimg.com/originals/be/d7/80/bed780f05b8d545a63fbfcd5e6372a70.jpg",R.drawable.bibimbap , "SOUP", "Guk/ Jjigae", "Chaesik is all about vegetarian dish in Korea..."));
        ...
        items.add(new CategoryPageItems("https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/Dak-kkochi.jpg/220px-Dak-kkochi.jpg" ,R.drawable.bibimbap, "STREET FOOD", "Bunsik","Chaesik is all about vegetarian dish in Korea..."));
